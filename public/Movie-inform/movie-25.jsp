...
<body>
		...
		<div id="contents">
			<div id="select_main">
				...
				<div class="movie-sector">
					<div class="box-image">
						<span class="thumb-image"> <img src="./images/TM.jpg">
							<!--포스터-->
						</span>
					</div>
					<!--박스콘텐츠-->
    ...
    <div class="title">
        <strong>머펫 대소동</strong>
        <p style="margin-top: 10px;">The Muppets</p>
    </div>
    <div class="spec" style="margin-top: 5px;">
        <dl>
            <dt>감독 : 제임스 보빈</dt>
            <dt>배우 : 제이슨 세걸, 크리스 쿠퍼, 에이미 아담스... </dt>
            <dt>장르 : 뮤지컬</dt>
            <dt>개봉 : 2011</dt>
        </dl>
    </div>
    <div id="like" class="like" style="margin-top: 48px;">
        <img src="./images/stillcut.png" onclick="location.href='./UIcard/card-25.jsp'">
...
<div class="story"> 세명의 팬들의 도움으로 머펫들은 그들의 오래된 스튜디오를 지키기 위해 재결합한다.
<br><br><br><br>
</div>
			...
			<div class="slide">
				<div id="myCarousel" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						...
						%>
						<div class="item">
							<img src="./images/TM<%=i%>.jpg" style="margin: 0 auto;">
						</div>
						<!--나머지 이미지-->
						<%
							}
