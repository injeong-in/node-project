		...
		<div id="contents">
			<div id="select_main">
				...
				<div class="movie-sector">
					<div class="box-image">
						<span class="thumb-image"> <img src="./images/TI.jpg">
							<!--포스터-->
						</span>
					</div>
					<!--박스콘텐츠-->
<div class="box-contents">
    <div class="title">
        <strong>인턴</strong>
        <p style="margin-top: 10px;">The Intern</p>
    </div>
    <div class="spec" style="margin-top: 5px;">
        <dl>
            <dt>감독 : 낸시 마이어스</dt>
            <dt>배우 : 앤 해서웨이, 로버트 드 니로 ... </dt>
            <dt>장르 : 코미디</dt>
            <dt>개봉 : 2015</dt>
        </dl>
    </div>
    <div id="like" class="like" style="margin-top: 48px;">
        <img src="./images/stillcut.png" onclick="location.href='./UIcard/card-67.jsp'">
...
<div class="story">프라다 입은 악마를 벗어난 '앤 해서웨이',
    수트 입은 70세 인턴 '로버트 드 니로'를 만나다!
    <br>
    창업 1년 반 만에 직원 220명의 성공신화를 이룬 줄스(앤 해서웨이).
    <br>
    수십 년 직장생활에서 비롯된 노하우와 나이만큼 풍부한 인생경험이 무기인 만능 70세의 벤(로버트 드 니로)을 인턴으로 채용하게 되는데..
    <br><br><br><br>
</div>
			...
			<div class="slide">
				<div id="myCarousel" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						...
						%>
						<div class="item">
							<img src="./images/TI<%=i%>.jpg" style="margin: 0 auto;">
						</div>
						<!--나머지 이미지-->
						<%
							}
