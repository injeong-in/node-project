...
<body>
		...
		<div id="contents">
			<div id="select_main">
				...
				<div class="movie-sector">
					<div class="box-image">
						<span class="thumb-image"> <img src="./images/KAD.jpg">
							<!--포스터-->
						</span>
					</div>
					<!--박스콘텐츠-->
    ...
    <div class="title">
        <strong>나잇&데이</strong>
        <p style="margin-top: 10px;">Knight & Day</p>
    </div>
    <div class="spec" style="margin-top: 5px;">
        <dl>
            <dt>감독 : 제임스 맨골드</dt>
            <dt>배우 : 톰 크루즈, 카메론 디아즈... </dt>
            <dt>장르 : 코미디</dt>
            <dt>개봉 : 2010</dt>
        </dl>
    </div>
    <div id="like" class="like" style="margin-top: 48px;">
        <img src="./images/stillcut.png" onclick="location.href='./UIcard/card-14.jsp'">
...
<div class="story">평범한 커리어 우먼 준(카메론 디아즈)은 우연히 공항에서 꿈에 그리던 이상형의 남자 밀러(톰 크루즈)를 만나 함께 비행기에 탑승하게 된다.
<br> 하지만 그녀가 잠시 화장실 다녀온 사이 비행기 안을 쑥대밭으로 만들어버린 밀러. 자신을 스파이라고 소개하지만 준은 그의 정체를 믿을 수 없다.
<br> 이미 자신도 모르는 사이에 그의 비밀 프로젝트에 깊숙히 휘말리게 된 준은 밀러와 함께 전 세계를 누비는 목숨을 건 질주를 시작한다. <br><br><br><br>
</div>
			...
			<div class="slide">
				<div id="myCarousel" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						...
						%>
						<div class="item">
							<img src="./images/KAD<%=i%>.jpg" style="margin: 0 auto;">
						</div>
						<!--나머지 이미지-->
						<%
							}
