...
<body>
		...
		<div id="contents">
			<div id="select_main">
				...
				<div class="movie-sector">
					<div class="box-image">
						<span class="thumb-image"> <img src="./images/EG.jpg">
							<!--포스터-->
						</span>
					</div>
					<!--박스콘텐츠-->
    ...
    <div class="spec" style="margin-top: 5px;">
        <dl>
            ...
            <dt>배우 : 톰 히들스턴, 제레미 레너, 크리스 헴스워스, 마크 러팔로, 스칼릿 조핸슨, 크리스 에반스, 로버트 다우니 주니어 ... </dt>
            <dt>장르 : SF판타지</dt>
            <dt>개봉 : 2019</dt>
        </dl>
    </div>
...
<div class="story">인피니티 워 이후 절반만 살아남은 지구
    <br>
    마지막 희망이 된 어벤져스
			...
			<div class="slide">
				<div id="myCarousel" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						...
						%>
						<div class="item">
							<img src="./images/EG<%=i%>.jpg" style="margin: 0 auto;">
						</div>
						<!--나머지 이미지-->
						<%
							}
