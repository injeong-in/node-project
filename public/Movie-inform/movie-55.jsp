...
<body>
		...
		<div id="contents">
			<div id="select_main">
				...
				<div class="movie-sector">
					<div class="box-image">
						<span class="thumb-image"> <img src="./images/IW.jpg">
							<!--포스터-->
						</span>
					</div>
					<!--박스콘텐츠-->
    ...
    <div class="title">
        <strong>어벤져스:인피니티 워</strong>
        <p style="margin-top: 10px;">Avengers:Infinity War</p>
    </div>
    <div class="spec" style="margin-top: 5px;">
        <dl>
            <dt>감독 : 안소니 루소, 조 루소</dt>
            <dt>배우 : 톰 히들스턴, 제레미 레너, 크리스 헴스워스, 마크 러팔로, 스칼릿 조핸슨, 크리스 에반스, 로버트 다우니 주니어, 사무엘 L. 잭슨 ... </dt>
            <dt>장르 : SF판타지</dt>
            <dt>개봉 : 2018</dt>
        </dl>
    </div>
...
<div class="story">새로운 조합을 이룬 어벤져스
    <br>
			...
			<div class="slide">
				<div id="myCarousel" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						...
						%>
						<div class="item">
							<img src="./images/IW<%=i%>.jpg" style="margin: 0 auto;">
						</div>
						<!--나머지 이미지-->
						<%
							}
