...
<body>
		...
		<div id="contents">
			<div id="select_main">
				...
				<div class="movie-sector">
					<div class="box-image">
						<span class="thumb-image"> <img src="./images/Ssg.jpg">
							<!--포스터-->
						</span>
					</div>
					<!--박스콘텐츠-->
    ...
    <div class="title">
        <strong>수상한그녀</strong>
        <p style="margin-top: 10px;">Miss Granny</p>
    </div>
    ...
    <div id="like" class="like" style="margin-top: 48px;">
        <img src="./images/stillcut.png" onclick="location.href='./UIcard/card-40.jsp'">
...
<div class="story">스무살 꽃처녀가 된 칠순 할매의 빛나는 전성기가 시작된다!<br>
			...
			<div class="slide">
				<div id="myCarousel" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						...
						%>
						<div class="item">
							<img src="./images/Ssg<%=i%>.png" style="margin: 0 auto;">
						</div>
						<!--나머지 이미지-->
						<%
							}
