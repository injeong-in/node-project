...
<body>
		...
		<div id="contents">
			<div id="select_main">
				...
				<div class="movie-sector">
					<div class="box-image">
						<span class="thumb-image"> <img src="./images/Baram.jpg">
							<!--포스터-->
						</span>
					</div>
					<!--박스콘텐츠-->
    ...
    <div class="title">
        <strong>바람과 함께 사라지다</strong>
        <p style="margin-top: 10px;">The Grand Heist</p>
    </div>
    <div class="spec" style="margin-top: 5px;">
        <dl>
            <dt>감독 : 김주호</dt>
            <dt>배우 : 차태현, 오지호, 성동일, 민효린, 고창석... </dt>
            <dt>장르 : 코미디</dt>
            <dt>개봉 : 2012</dt>
        </dl>
    </div>
    <div id="like" class="like" style="margin-top: 48px;">
        <img src="./images/stillcut.png" onclick="location.href='./UIcard/card-30.jsp'">
...
<div class="story"> 금보다 귀한 권력의 상징 ‘얼음’<br>
    총명함은 타고났으나 우의정의 서자요, 잡서적에 빠져 지내던 ‘덕무(차태현)’. 얼음 독점권을 차지하려는 좌의정 ‘조명수’에 의해 아버지가 누명을 쓰게 되자 그의 뒤통수를 칠 묘안을 떠올린다. 
    <br>
    최고의 ‘꾼’들이 모두 한자리에 모이게 되고, 3만정의 얼음을 훔치기 위한 본격 작전에 나서기 시작한다!
<br><br><br><br>
</div>
			...
			<div class="slide">
				<div id="myCarousel" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						...
						%>
						<div class="item">
							<img src="./images/Baram<%=i%>.jpg" style="margin: 0 auto;">
						</div>
						<!--나머지 이미지-->
						<%
							}
