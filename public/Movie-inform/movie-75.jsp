		...
		<div id="contents">
			<div id="select_main">
				...
				<div class="movie-sector">
					<div class="box-image">
						<span class="thumb-image"> <img src="./images/KFP2.jpg">
							<!--포스터-->
						</span>
					</div>
					<!--박스콘텐츠-->
<div class="box-contents">
    <div class="title">
        <strong>쿵푸팬더2</strong>
        <p style="margin-top: 10px;">Kung Fu Panda2</p>
    </div>
    <div class="spec" style="margin-top: 5px;">
        <dl>
            <dt>감독 : 여인영</dt>
            <dt>배우 : 잭 블랙, 더스틴 호프만, 안젤리나 졸리 ... </dt>
            <dt>장르 : 애니메이션</dt>
            <dt>개봉 : 2011</dt>
        </dl>
    </div>
			...
			<div class="slide">
				<div id="myCarousel" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						...
						%>
						<div class="item">
							<img src="./images/KFP2-<%=i%>.jpg" style="margin: 0 auto;">
						</div>
						<!--나머지 이미지-->
						<%
							}
