		...
		<div id="contents">
			<div id="select_main">
				...
				<div class="movie-sector">
					<div class="box-image">
						<span class="thumb-image"> <img src="./images/IC.jpg">
							<!--포스터-->
						</span>
					</div>
					<!--박스콘텐츠-->
<div class="box-contents">
    <div class="title">
        <strong>인셉션</strong>
        <p style="margin-top: 10px;">Inception</p>
    </div>
    <div class="spec" style="margin-top: 5px;">
        <dl>
            <dt>감독 : 크리스토퍼 놀란</dt>
            <dt>배우 : 톰 하디, 조셉 고든 레빗, 엘렌 페이지, 마리옹 코티야르, 레오나르도 디카프리오 ... </dt>
            <dt>장르 : 드라마</dt>
            <dt>개봉 : 2010</dt>
        </dl>
    </div>
...
<div class="story">타인의 꿈에 들어가 생각을 훔치는 특수 보안요원 코브.
    <br>
			...
			<div class="slide">
				<div id="myCarousel" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						...
						%>
						<div class="item">
							<img src="./images/IC<%=i%>.jpg" style="margin: 0 auto;">
						</div>
						<!--나머지 이미지-->
						<%
							}
