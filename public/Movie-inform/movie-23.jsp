...
<body>
		...
		<div id="contents">
			<div id="select_main">
				...
				<div class="movie-sector">
					<div class="box-image">
						<span class="thumb-image"> <img src="./images/RS.jpg">
							<!--포스터-->
						</span>
					</div>
					<!--박스콘텐츠-->
   ...
   <div class="box-contents">
    <div class="title">
        <strong>리얼스틸</strong>
        <p style="margin-top: 10px;">Real Steel</p>
    </div>
    <div class="spec" style="margin-top: 5px;">
        <dl>
            <dt>감독 : 숀 레비</dt>
            <dt>배우 : 앤서니 매키, 에반젤린 릴리, 다코타 고요, 휴 잭맨... </dt>
            <dt>장르 : SF판타지</dt>
            <dt>개봉 : 2011</dt>
        </dl>
    </div>
    <div id="like" class="like" style="margin-top: 48px;">
        <img src="./images/stillcut.png" onclick="location.href='./UIcard/card-23.jsp'">
...
<div class="story"> 치열한 로봇 파이터들의 세계를 그려낸 블록버스터
    로봇 파이터의 불가능한 도전이 시작된다!<br>
    2020년, 관중들의 뜨거운 열기로 가득 찬 복싱 경기장. 링 위에서 숨 막히는 승부를 펼치는 이들은 무려 900kg에 2m 50cm가 넘는 거대한 로봇 파이터들이다.
<br>  오직 승자와 패자만이 존재하는 무자비한 사각의 링 위, 이제 더 이상 물러날 곳이 없는 찰리와 맥스, 그리고 ‘아톰’의 불가능한 도전이 시작된다!<br><br><br><br>
</div>
			...
			<div class="slide">
				<div id="myCarousel" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						...
						%>
						<div class="item">
							<img src="./images/RS<%=i%>.jpg" style="margin: 0 auto;">
						</div>
						<!--나머지 이미지-->
						<%
							}
