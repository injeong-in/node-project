		...
		<div id="contents">
			<div id="select_main">
				...
				<div class="movie-sector">
					<div class="box-image">
						<span class="thumb-image"> <img src="./images/KTSS.jpg">
							<!--포스터-->
						</span>
					</div>
					<!--박스콘텐츠-->
<div class="box-contents">
    <div class="title">
        <strong>킹스맨:시크릿 에이전트</strong>
        <p style="margin-top: 10px;">Kingsman:The Secret Service</p>
    </div>
    <div class="spec" style="margin-top: 5px;">
        <dl>
            <dt>감독 : 매튜 본</dt>
            <dt>배우 : 태런 에저튼, 콜린 퍼스 ... </dt>
            <dt>장르 : 공포,스릴러</dt>
            <dt>개봉 : 2015</dt>
        </dl>
    </div>
    <div id="like" class="like" style="margin-top: 48px;">
        <img src="./images/stillcut.png" onclick="location.href='./UIcard/card-76.jsp'">
...
<div class="story">세상에서 가장 위험한 면접이 시작된다!
    <br>
			...
			<div class="slide">
				<div id="myCarousel" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						...
						%>
						<div class="item">
							<img src="./images/KTSS<%=i%>.jpg" style="margin: 0 auto;">
						</div>
						<!--나머지 이미지-->
						<%
							}
