...
<body>
    ...
    <div class="title">
        <strong>겨울왕국2</strong>
        <p style="margin-top: 10px;">Frozen2</p>
    </div>
    <div class="spec" style="margin-top: 5px;">
        <dl>
            <dt>감독 : 크리스 벅, 제니퍼 리</dt>
            <dt>배우 : 조시 게드, 조나단 그로프, 크리스틴 벨, 이디나 멘젤... </dt>
            <dt>장르 : 애니메이션</dt>
            <dt>개봉 : 2019</dt>
        </dl>
    </div>
...
<div class="story">어느 날 부턴가 의문의 목소리가 엘사를 부르고, 평화로운 아렌델 왕국을 위협한다. 
<br>위험에 빠진 아렌델 왕국을 구해야만 하는 엘사와 안나는 숨겨진 과거의 진실을 찾아 크리스토프, 올라프 그리고 스벤과 함께 위험천만한 놀라운 모험을 떠나게 된다. 
<br> 두려움을 깨고 새로운 운명을 만나다! <br><br><br><br>
</div>
		...
		<div id="myCarousel" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner">
				...
				<%for(int i=6; i<10; i++) {%>
				<div class ="item">
					<img src="./images/F2-<%=i%>.jpg" style="margin:0 auto;">
				</div>
				<% } %>
			</div>
