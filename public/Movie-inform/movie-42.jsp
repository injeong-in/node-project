...
<body>
		...
		<div id="contents">
			<div id="select_main">
				...
				<div class="movie-sector">
					<div class="box-image">
						<span class="thumb-image"> <img src="./images/FFH.jpg">
							<!--포스터-->
						</span>
					</div>
					<!--박스콘텐츠-->
    ...
    <div class="title">
        <strong>스파이더맨:파 프롬홈</strong>
        <p style="margin-top: 10px;">Spider-Man:Far From Home</p>
    </div>
    <div class="spec" style="margin-top: 5px;">
        <dl>
            <dt>감독 : 존 왓츠</dt>
            <dt>배우 : 코비 스멀더스, 사무엘 L. 잭슨, 톰 홀랜드 ... </dt>
            <dt>장르 : 액션</dt>
            <dt>개봉 : 2019</dt>
        </dl>
    </div>
    <div id="like" class="like" style="margin-top: 48px;">
        <img src="./images/stillcut.png" onclick="location.href='./UIcard/card-42.jsp'">
...
<div class="story">모든 것이 다시 시작된다!<br>
    ‘엔드게임’ 이후 변화된 세상,
			...
			<div class="slide">
				<div id="myCarousel" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						...
						%>
						<div class="item">
							<img src="./images/FFH<%=i%>.jpg" style="margin: 0 auto;">
						</div>
						<!--나머지 이미지-->
						<%
							}
