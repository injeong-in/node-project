...
<body>
		...
		<div id="contents">
			<div id="select_main">
				...
				<div class="movie-sector">
					<div class="box-image">
						<span class="thumb-image"> <img src="./images/B.jpg">
							<!--포스터-->
						</span>
					</div>
					<!--박스콘텐츠-->
    ...
    <div class="title">
        <strong>버레스크</strong>
        <p style="margin-top: 10px;">Burlesque</p>
    </div>
    <div class="spec" style="margin-top: 5px;">
        <dl>
            <dt>감독 : 스티브 앤틴</dt>
            <dt>배우 : 크리스티나 아길레라, 셰어... </dt>
            <dt>장르 : 뮤지컬</dt>
            <dt>개봉 : 2010</dt>
        </dl>
    </div>
    <div id="like" class="like" style="margin-top: 48px;">
        <img src="./images/stillcut.png" onclick="location.href='./UIcard/card-31.jsp'">
...
<div class="story">순박한 시골 소녀 앨리 로즈는 큰 무대에서 노래 부르고 싶다는 꿈을 안고 LA로 향한다.<br>
    곳에서 그녀는 우연히 ‘버레스크’라는 클럽을 발견하고, 춤과 노래가 환상적으로 어우러진 새로운 세계에 빠진다. 
    <br>
    어느 날 전설적인 디바이자 클럽 주인인 테스의 눈에 띄어 그녀가 꿈꾸던 솔로 무대에 서게 되는데...
<br><br><br><br>
</div>
			...
			<div class="slide">
				<div id="myCarousel" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						...
						%>
						<div class="item">
							<img src="./images/B<%=i%>.jpg" style="margin: 0 auto;">
						</div>
						<!--나머지 이미지-->
						<%
							}
