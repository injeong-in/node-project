...
<body>
		...
		<div id="contents">
			<div id="select_main">
				...
				<div class="movie-sector">
					<div class="box-image">
						<span class="thumb-image"> <img src="./images/Jikeob.jpg">
							<!--포스터-->
						</span>
					</div>
					<!--박스콘텐츠-->
    ...
    <div class="spec" style="margin-top: 5px;">
        <dl>
            <dt>감독 : 이병헌</dt>
            <dt>배우 : 진선규, 이동휘, 이하늬, 공명, 류승룡... </dt>
            <dt>장르 : 코미디</dt>
            <dt>개봉 : 2019</dt>
        </dl>
    </div>
    <div id="like" class="like" style="margin-top: 48px;">
        <img src="./images/stillcut.png" onclick="location.href='./UIcard/card-11.jsp'">
...
<div class="story">불철주야 달리고 구르지만 실적은 바닥, 급기야 해체 위기를 맞는 마약반!
<br>더 이상 물러설 곳이 없는 팀의 맏형 고반장은 국제 범죄조직의 국내 마약 밀반입 정황을 포착하고
장형사, 마형사, 영호, 재훈까지 4명의 팀원들과 함께 잠복 수사에 나선다. 
<br> 치킨장사로 눈코 뜰 새 없이 바빠진 마약반에게 어느 날 절호의 기회가 찾아오는데…
범인을 잡을 것인가, 닭을 잡을 것인가! <br><br><br><br>
</div>
			...
			<div class="slide">
				<div id="myCarousel" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						...
						%>
						<div class="item">
							<img src="./images/Jikeob<%=i%>.jpg" style="margin: 0 auto;">
						</div>
						<!--나머지 이미지-->
						<%
							}
