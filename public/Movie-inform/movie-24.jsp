...
<body>
		...
		<div id="contents">
			<div id="select_main">
				...
				<div class="movie-sector">
					<div class="box-image">
						<span class="thumb-image"> <img src="./images/MM2.jpg">
							<!--포스터-->
						</span>
					</div>
					<!--박스콘텐츠-->
    ...
    <div class="title">
        <strong>맘마미아2</strong>
        <p style="margin-top: 10px;">Mamma Mia2</p>
    </div>
    <div class="spec" style="margin-top: 5px;">
        <dl>
            <dt>감독 : 올 파커</dt>
            <dt>배우 : 콜린 퍼스, 제레미 어바인, 아만다 사이프리드, 메릴 스트립, 릴리 제임스... </dt>
            <dt>장르 : 뮤지컬</dt>
            <dt>개봉 : 2018</dt>
        </dl>
    </div>
    <div id="like" class="like" style="margin-top: 48px;">
        <img src="./images/stillcut.png" onclick="location.href='./UIcard/card-24.jsp'">
...
<div class="story"> 전세계가 사랑한 최고의 뮤지컬 영화가 돌아온다!
    “인생은 짧고 세상은 넓어. 멋진 추억을 만들고 싶어!”<br>
    엄마 도나(메릴 스트립)의 모든 것이 담긴 호텔 재개장을 준비하며 홀로서기를 결심한 소피.
 그녀는 엄마의 영원한 친구 타냐와 로지,
 그리고 사랑스러운 세 아빠들 샘, 해리, 빌에게 리오픈 파티 초대장을 보낸다.
<br>  한편 소피는 파티 준비 중 엄마의 숨겨진 찬란했던 추억과 비밀을 들여다보게 되고,
뜻밖의 손님까지 방문하는데… 과연 한여름의 파티는 무사히 열릴 수 있을까?<br><br><br><br>
</div>
			...
			<div class="slide">
				<div id="myCarousel" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						...
						%>
						<div class="item">
							<img src="./images/MM2-<%=i%>.jpg" style="margin: 0 auto;">
						</div>
						<!--나머지 이미지-->
						<%
							}
