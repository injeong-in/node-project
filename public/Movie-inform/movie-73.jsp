		...
		<div id="contents">
			<div id="select_main">
				...
				<div class="movie-sector">
					<div class="box-image">
						<span class="thumb-image"> <img src="./images/CC.jpg">
							<!--포스터-->
						</span>
					</div>
					<!--박스콘텐츠-->
<div class="box-contents">
    <div class="title">
        <strong>코코</strong>
        <p style="margin-top: 10px;">Coco</p>
    </div>
    <div class="spec" style="margin-top: 5px;">
        <dl>
            <dt>감독 : 리 언크리치</dt>
            <dt>배우 : 르네 빅터, 벤자민 브랫, 안소니 곤잘레스, 가엘 가르시아 베르날 ... </dt>
            <dt>장르 : 애니메이션</dt>
            <dt>개봉 : 2018</dt>
        </dl>
    </div>
...
<div class="story">영원히 기억하고 싶은 황홀한 모험이 시작된다!
    <br>
			...
			<div class="slide">
				<div id="myCarousel" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						...
						%>
						<div class="item">
							<img src="./images/CC<%=i%>.jpg" style="margin: 0 auto;">
						</div>
						<!--나머지 이미지-->
						<%
							}
