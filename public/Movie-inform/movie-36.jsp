...
<body>
    ...
    <div class="title">
        <strong>비긴 어게인</strong>
        <p style="margin-top: 10px;">Begin Again</p>
    </div>
    <div class="spec" style="margin-top: 5px;">
        <dl>
            <dt>감독 : 존 카니</dt>
            <dt>배우 : 마크 러팔로, 키이나 나이틀리... </dt>
            <dt>장르 : 로맨스</dt>
            <dt>개봉 : 2014</dt>
        </dl>
    </div>
    <div id="like" class="like" style="margin-top: 48px;">
        <img src="./images/stillcut.png" onclick="location.href='./UIcard/card-36.jsp'">
...
<div class="story">“다시 시작해, 너를 빛나게 할 노래를!”<br>
