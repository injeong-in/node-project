		...
		<div id="contents">
			<div id="select_main">
				...
				<div class="movie-sector">
					<div class="box-image">
						<span class="thumb-image"> <img src="./images/J.jpg">
							<!--포스터-->
						</span>
					</div>
					<!--박스콘텐츠-->
<div class="box-contents">
    <div class="title">
        <strong>조커</strong>
        <p style="margin-top: 10px;">Joker</p>
    </div>
    <div class="spec" style="margin-top: 5px;">
        <dl>
            <dt>감독 : 토드 필립스</dt>
            <dt>배우 : 호아킨피닉스, 로버트 드 니로 ... </dt>
            <dt>장르 : 공포,스릴러</dt>
            <dt>개봉 : 2019</dt>
        </dl>
    </div>
...
<div class="story">“내 인생이 비극인줄 알았는데, 코미디였어”
    <br>
			...
			<div class="slide">
				<div id="myCarousel" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						...
						%>
						<div class="item">
							<img src="./images/J<%=i%>.jpg" style="margin: 0 auto;">
						</div>
						<!--나머지 이미지-->
						<%
							}
