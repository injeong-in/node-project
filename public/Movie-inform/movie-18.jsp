...
<body>
		...
		<div id="contents">
			<div id="select_main">
				...
				<div class="movie-sector">
					<div class="box-image">
						<span class="thumb-image"> <img src="./images/TDKR.jpg">
							<!--포스터-->
						</span>
					</div>
					<!--박스콘텐츠-->
    ...
    <div class="title">
        <strong>다크 나이트 라이즈</strong>
        <p style="margin-top: 10px;">The Dark Knight Rises</p>
    </div>
    <div class="spec" style="margin-top: 5px;">
        <dl>
            <dt>감독 : 크리스토퍼 놀란</dt>
            <dt>배우 : 모건 프리먼, 마리옹 코티야르, 톰 하디, 조셉 고든 레빗, 앤 해서웨이, 크리스찬 베일,
                마이클 케인... </dt>
            <dt>장르 : 공포,스릴러</dt>
            <dt>개봉 : 2012</dt>
        </dl>
    ...
    <div id="like" class="like" style="margin-top: 48px;">
        <img src="./images/stillcut.png" onclick="location.href='./UIcard/card-18.jsp'">
...
<div class="story"> 다크 나이트 신화의 전설이 끝난다.<br>
 ...
 최강의 적 베인이 등장한다.
<br>  자신을 거부한 사람들의 고통을 지켜볼 것인가, 정의의 수호자로 나설 것인가.
배트맨은 승패를 알 수 없는 마지막 전투를 시작하려 하는데… <br><br><br><br>
</div>
			...
			<div class="slide">
				<div id="myCarousel" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						...
						%>
						<div class="item">
							<img src="./images/TDKR<%=i%>.jpg" style="margin: 0 auto;">
						</div>
						<!--나머지 이미지-->
						<%
							}
