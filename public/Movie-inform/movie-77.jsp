		...
		<div id="contents">
			<div id="select_main">
				...
				<div class="movie-sector">
					<div class="box-image">
						<span class="thumb-image"> <img src="./images/Taxi.jpg">
							<!--포스터-->
						</span>
					</div>
					<!--박스콘텐츠-->
<div class="box-contents">
    <div class="title">
        <strong>택시운전사</strong>
        <p style="margin-top: 10px;">A Taxi Driver</p>
    </div>
    <div class="spec" style="margin-top: 5px;">
        <dl>
            <dt>감독 : 장훈</dt>
            <dt>배우 : 유해진, 토마스 크레치만, 송강호 ... </dt>
            <dt>장르 : 드라마</dt>
            <dt>개봉 : 2017</dt>
        </dl>
    </div>
    <div id="like" class="like" style="margin-top: 48px;">
        <img src="./images/stillcut.png" onclick="location.href='./UIcard/card-77.jsp'">
...
<div class="story">1980년 5월, 서울 택시운전사.
 ...
 독일기자 피터(토마스 크레취만)를 태우고 영문도 모른 채 길을 나선다.
    <br>
    그러나 만섭은 집에 혼자 있을 딸 걱정에 점점 초조해지는데…
    <br><br><br><br>
</div>
			...
			<div class="slide">
				<div id="myCarousel" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						...
						%>
						<div class="item">
							<img src="./images/Taxi<%=i%>.jpg" style="margin: 0 auto;">
						</div>
						<!--나머지 이미지-->
						<%
							}
