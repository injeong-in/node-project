		...
		<div id="contents">
			<div id="select_main">
				...
				<div class="movie-sector">
					<div class="box-image">
						<span class="thumb-image"> <img src="./images/C.jpg">
							<!--포스터-->
						</span>
					</div>
					<!--박스콘텐츠-->
<div class="box-contents">
    <div class="title">
        <strong>캣츠</strong>
        <p style="margin-top: 10px;">Cats</p>
    </div>
    <div class="spec" style="margin-top: 5px;">
        <dl>
            <dt>감독 : 톰 후퍼</dt>
            <dt>배우 : 제임스 코든, 제니퍼 허드슨, 이드리스 엘바, 테일러 스위프트, 프란체스카 헤이워드 ... </dt>
            <dt>장르 : 뮤지컬</dt>
            <dt>개봉 : 2019</dt>
        </dl>
    </div>
    <div id="like" class="like" style="margin-top: 48px;">
        <img src="./images/stillcut.png" onclick="location.href='./UIcard/card-71.jsp'">
...
<div class="story">오늘밤, 운명을 바꿀 마법 같은 기회가 찾아온다!
    <br>
			...
			<div class="slide">
				<div id="myCarousel" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						...
						%>
						<div class="item">
							<img src="./images/C<%=i%>.jpg" style="margin: 0 auto;">
						</div>
						<!--나머지 이미지-->
						<%
							}
