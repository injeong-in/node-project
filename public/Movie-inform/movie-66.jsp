		...
		<div id="contents">
			<div id="select_main">
				...
				<div class="movie-sector">
					<div class="box-image">
						<span class="thumb-image"> <img src="./images/I.jpg">
							<!--포스터-->
						</span>
					</div>
					<!--박스콘텐츠-->
<div class="box-contents">
    <div class="title">
        <strong>인터스텔라</strong>
        <p style="margin-top: 10px;">Interstellar</p>
    </div>
    <div class="spec" style="margin-top: 5px;">
        <dl>
            <dt>감독 : 크리스토퍼 놀란</dt>
            <dt>배우 : 제시카 차스테인, 캐시 애플렉, 매튜 맥커너히, 앤 해서웨이, 마이클 케인 ... </dt>
            <dt>장르 : SF판타지</dt>
            <dt>개봉 : 2014</dt>
        </dl>
    </div>
    <div id="like" class="like" style="margin-top: 48px;">
        <img src="./images/stillcut.png" onclick="location.href='./UIcard/card-66.jsp'">
...
<div class="story">“우린 답을 찾을 거야, 늘 그랬듯이”
    <br>
			...
			<div class="slide">
				<div id="myCarousel" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						...
						%>
						<div class="item">
							<img src="./images/I<%=i%>.jpg" style="margin: 0 auto;">
						</div>
						<!--나머지 이미지-->
						<%
							}
