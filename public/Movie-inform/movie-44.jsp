...
<body>
		...
		<div id="contents">
			<div id="select_main">
				...
				<div class="movie-sector">
					<div class="box-image">
						<span class="thumb-image"> <img src="./images/Sirano.jpg">
							<!--포스터-->
						</span>
					</div>
					<!--박스콘텐츠-->
    ...
    <div class="title">
        <strong>시라노:연애 조작단</strong>
        <p style="margin-top: 10px;">Cyrano Agency</p>
    </div>
    <div class="spec" style="margin-top: 5px;">
        <dl>
            <dt>감독 : 김현석</dt>
            <dt>배우 : 박신혜, 최 다니엘, 이민정, 엄태웅 ... </dt>
            <dt>장르 : 로맨스</dt>
            <dt>개봉 : 2010</dt>
        </dl>
    </div>
    <div id="like" class="like" style="margin-top: 48px;">
        <img src="./images/stillcut.png" onclick="location.href='./UIcard/card-44.jsp'">
...
<div class="story">여자가 모르는 남자들의 은밀한 연애작전<br>
    100% 성공률에 도전하는 ‘시라노 에이전시’는 연애에 서투른 사람들을 대신해 연애를 이루어주는 연애조작단이다.
    <br>
    의뢰인의 타깃녀 희중의 프로필을 본 순간, 고민에 빠진 병훈…
    <br><br><br><br>
</div>
			...
			<div class="slide">
				<div id="myCarousel" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						...
						%>
						<div class="item">
							<img src="./images/Sirano<%=i%>.jpg" style="margin: 0 auto;">
						</div>
						<!--나머지 이미지-->
						<%
							}
