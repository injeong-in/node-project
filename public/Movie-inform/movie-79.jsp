		...
		<div id="contents">
			<div id="select_main">
				...
				<div class="movie-sector">
					<div class="box-image">
						<span class="thumb-image"> <img src="./images/T.jpg">
							<!--포스터-->
						</span>
					</div>
					<!--박스콘텐츠-->
<div class="box-contents">
    <div class="title">
        <strong>터보</strong>
        <p style="margin-top: 10px;">Turbo</p>
    </div>
    ...
    <div id="like" class="like" style="margin-top: 48px;">
        <img src="./images/stillcut.png" onclick="location.href='./UIcard/card-79.jsp'">
...
<div class="story">열라 빠른 슈퍼 달팽이 '터보’가 온다!
    <br>
    카레이싱 중계를 보며 세상에서 가장 빨리 달리고 싶은 ‘터보’는 세계적인 레이싱 챔피언 ‘기 가니에’ 와 맞서 경주하는 것을 꿈꾸는 달팽이.
    <br>
			...
			<div class="slide">
				<div id="myCarousel" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						...
						%>
						<div class="item">
							<img src="./images/T<%=i%>.jpg" style="margin: 0 auto;">
						</div>
						<!--나머지 이미지-->
						<%
							}
