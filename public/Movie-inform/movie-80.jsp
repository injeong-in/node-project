		...
		<div id="contents">
			<div id="select_main">
				...
				<div class="movie-sector">
					<div class="box-image">
						<span class="thumb-image"> <img src="./images/T3.jpg">
							<!--포스터-->
						</span>
					</div>
					<!--박스콘텐츠-->
<div class="box-contents">
    <div class="title">
        <strong>트랜스포머3:달의 어둠</strong>
        <p style="margin-top: 10px;">Transformers3:Dark Of The Moon</p>
    </div>
    <div class="spec" style="margin-top: 5px;">
        <dl>
            <dt>감독 : 마이클 베이</dt>
            <dt>배우 : 로지 헌팅턴화이틀리, 샤이아 라보프 ... </dt>
            <dt>장르 : 액션</dt>
            <dt>개봉 : 2011</dt>
        </dl>
    </div>
    <div id="like" class="like" style="margin-top: 48px;">
        <img src="./images/stillcut.png" onclick="location.href='./UIcard/card-80.jsp'">
...
<div class="story">지구의 운명을 건 최후의 전면전
    <br>
			...
			<div class="slide">
				<div id="myCarousel" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						...
						%>
						<div class="item">
							<img src="./images/T3-<%=i%>.jpg" style="margin: 0 auto;">
						</div>
						<!--나머지 이미지-->
						<%
							}
