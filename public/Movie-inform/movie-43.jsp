...
<body>
		...
		<div id="contents">
			<div id="select_main">
				...
				<div class="movie-sector">
					<div class="box-image">
						<span class="thumb-image"> <img src="./images/HC.jpg">
							<!--포스터-->
						</span>
					</div>
					<!--박스콘텐츠-->
    ...
    <div class="title">
        <strong>스파이더맨:홈커밍</strong>
        <p style="margin-top: 10px;">Spider-Man:Homecoming</p>
    </div>
    <div class="spec" style="margin-top: 5px;">
        <dl>
            <dt>감독 : 존 왓츠</dt>
            <dt>배우 : 마이클 키튼, 톰 홀랜드, 로버트 다우니 주니어 ... </dt>
            <dt>장르 : SF판타지</dt>
            <dt>개봉 : 2017</dt>
        </dl>
    </div>
...
<div class="story">마블 히어로의 세대교체!
    “어벤져스가 되려면 시험 같은 거 봐요?”<br>
			...
			<div class="slide">
				<div id="myCarousel" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						...
						%>
						<div class="item">
							<img src="./images/HC<%=i%>.jpg" style="margin: 0 auto;">
						</div>
						<!--나머지 이미지-->
						<%
							}
