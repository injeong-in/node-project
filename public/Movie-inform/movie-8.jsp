		...
		<div id="contents">
			<div id="select_main">
				...
				<div class="movie-sector">
					<div class="box-image">
						<span class="thumb-image"> <img src="./images/Gg.jpg">
							<!--포스터-->
						</span>
					</div>
					<!--박스콘텐츠-->
					<div class="box-contents">
						<div class="title">
							<strong>공조</strong>
							<p style="margin-top: 10px;">Confidential Assignment</p>
						</div>
						...
						<div id="like" class="like" style="margin-top: 48px;">
							<img src="./images/stillcut.png" onclick="location.href='./UIcard/card-8.jsp'">
			...
			<div class="story">
				...
				북한형사 ‘림철령’(현빈). <br>임무를 완수해야 하는 철령과 임무를 막아야만 하는 진태. <br>
				그들에게 주어진 시간은 단 3일, 한 팀이 될 수 없는 남북 형사의 예측불가 공조수사가 시작된다! <br>
				<br>
				<br>
				<br>
			</div>
			...
			<div class="slide">
				<div id="myCarousel" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						...
						%>
						<div class="item">
							<img src="./images/Gg<%=i%>.jpg" style="margin: 0 auto;">
						</div>
						<!--나머지 이미지-->
						<%
							}
